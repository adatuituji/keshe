...
/* 代码安全寄存器 */
#define CSPR            (*((volatile unsigned char *) 0xE01FC184))      /* lpc2130 only */
...
// 为LPC213x增加定时器0计数控制器  2005-02-22
...
// 为LPC213x增加定时器1计数控制器  2005-02-22
...
#define ADGSM           (*((volatile unsigned long *) 0xE0034008))      
#define AD1CR           (*((volatile unsigned long *) 0xE0060000))      
#define AD1DR           (*((volatile unsigned long *) 0xE0060004))      

/* D/A CONVERTER */
/* D/A转换器 */
#define DACR            (*((volatile unsigned long *) 0xE006C000))      /* lpc2138 only */
